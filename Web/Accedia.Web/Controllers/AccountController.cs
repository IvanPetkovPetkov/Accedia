namespace Accedia.Web.Controllers
{
    ...
    using Accedia.Web.ViewModels.Account;
    using System;
    using Services.Data;
    [Authorize]
    public class AccountController : BaseController
    {
        ...
        private readonly IUserAccadiaService userAccadiaService;

        private ApplicationSignInManager signInManager;

        private ApplicationUserManager userManager;

        public AccountController(IUserAccadiaService userAccadiaService)
        {
            this.userAccadiaService = userAccadiaService;
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IUserAccadiaService userAccadiaService)
        {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if ((upload != null) && (upload.ContentLength > 0))
                    {
                        ...
                        fileFullPath = System.IO.Path.Combine(this.Server.MapPath("~/App_Data/uploads"), Guid.NewGuid().ToString() + fileName);
                        upload.SaveAs(fileFullPath);
                    }
                    ...
                    var userAccedia = new UserAccedia
                    {
                    ...
                    this.userAccadiaService.AddUserWithAddress(userAccedia, address);
